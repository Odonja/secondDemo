...
import org.anhu.elements.RandomMessagePayloadGenerator;
...
public class SecondDemoApplicationTests {
	...
	private static final String SEND_MOVE_ENDPOINT = "/app/create";
	private static final String SUBSCRIBE_MOVE_ENDPOINT = "/topic/creation";
	...
	public void testCreateGameEndpoint()
		...
		stompSession.send(SEND_MOVE_ENDPOINT, RandomMessagePayloadGenerator.generateRandomMessage());
		System.out.println("sent");

		MessagePayload pv = completableFuture.get(10, SECONDS);
		System.out.println("MessagePayload: " + pv);
		assertNotNull(pv);
	}
	...
	private class CreateGameStompFrameHandler implements StompFrameHandler {
		...
		public void handleFrame(StompHeaders stompHeaders, Object o) {
			...
			completableFuture.complete((MessagePayload) o);
		}
	}
}
